                ...
                <div class="row">
                    <div class="large-12 columns">
                        <label class="@if ($errors->has('werkgever')) error @endif">Werkgever
                            <input type="text" value="{{ Input::old('werkgever') }}" name="werkgever" placeholder="Job werkgever">
                        </label>
                ...
                <div class="row">
                    <div class="large-12 columns">
                        <label class="@if ($errors->has('email')) error @endif">Email
                            <input type="text" value="{{ Input::old('email') }}" name="email" placeholder=" email werkgever">
                        </label>
                    </div>
                </div>
                <div class="row">
                    <div class="large-12 columns">
                        <label class="@if ($errors->has('telefoon')) error @endif">Telefoon
                            <input type="text" value="{{ Input::old('telefoon') }}" name="telefoon" placeholder="telefoon werkgever">
                        </label>
                    </div>
                </div>
               <div class="row">
