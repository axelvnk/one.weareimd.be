                ...
                <div class="row">
                    <div class="large-12 columns">
						...
						<label class="@if ($errors->has('admin')) error @endif">Admin
							<input type="checkbox" id="admin" name="admin" value="admin" @if($user->admin==1) checked @endif>
						</label>
						<label class="@if ($errors->has('employee')) error @endif">Employee
							<input type="checkbox" id="employee" name="employee" value="employee" @if($user->type==1) checked @endif>
						</label>
                    </div>
                </div>
                <div class="row">
