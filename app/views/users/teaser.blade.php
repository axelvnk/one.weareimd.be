    ...
    <div id="wrapper">
        <div class="row">
            <div class="large-8 columns">
                <h1>One IMD app</h1>
                <h3>The site is currently under construction and will be online near the end of 2014. We will bring an online platform for all you IMD'ers out there. Sign up and be notified when we launch!</h3>
            </div>
        </div>
                ...
                <div class="large-8 columns">
                    <div class="row collapse">
                        ...
                        <div class="small-10 columns">
                            <input type="text" name="email" value="{{ Input::old('email') }}" placeholder="YourEmail@example.com">
                        </div>
