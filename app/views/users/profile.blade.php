...
<div class="row">
	<div class="medium-8 columns">
		@if(!$user->type)
		<h2><span class="level"><span class="lv">lvl.</span>{{$xp['level']}}</span>  {{ $user->firstname }} {{ $user->name }}</h2>
		<div class="xpbartop"><span class="xpbar"><span style="width: {{($xp['leftOverXP']/$xp['required'])*100}}%;" class="actualxp"></span><span class="xp">{{$xp['leftOverXP']}} / {{$xp['required']}} experience</span></span></div>
		@else
